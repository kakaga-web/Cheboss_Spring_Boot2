...
public class chebossCheckedException {
    public static void main(String[] args) throws IOException {
        ...
        FileReader fileReader = new FileReader(path); // fileReader object ( will be an argument of bufferReader )
        try (BufferedReader br = new BufferedReader(fileReader)) { // Java 7 closes the file for us ( no need for finally )
            String sCurrentLine;
